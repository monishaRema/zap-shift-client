      ...
      <form onSubmit={handleSubmit(onSubmit)}> 
        ...
        <fieldset className="flex flex-col mb-5">
          <div className="flex justify-between">
            ...
            <Link to='/forgot-password' className="underline text-gray-500 hover:text-primary">Forgot Password?</Link>
          </div>
        ...
        <button className="btn btn-accent w-full text-black capitalize text-base">Login</button>
      </form>
        <p className="text-gray-500 mt-2 mb-5">
          Don't have an account?{" "}
            <Link state={from} to="/register" className="text-lime-600 hover:underline font-semibold">
              Register
            </Link>
        </p>
